...
class DemoMWExpansionPanelScreen5 extends StatefulWidget {
  ...
  @override
  _DemoMWExpansionPanelScreen5State createState() =>
      _DemoMWExpansionPanelScreen5State();
}

class _DemoMWExpansionPanelScreen5State
    extends State<DemoMWExpansionPanelScreen5> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: MWExpansionPanel5ComponentWidget().paddingSymmetric(
      vertical: 8,
      horizontal: 16,
    ));
  }
